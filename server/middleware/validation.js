...
const validateRegister = (req, res, next) => {
  ...
  // Validate isCitizen (optional)
  if (isCitizen !== undefined && typeof isCitizen !== 'boolean') {
    errors.push('Citizenship status must be a boolean');
  }
