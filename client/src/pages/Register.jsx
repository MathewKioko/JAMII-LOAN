...
const Register = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.nationalId && !/^\d{9}$/.test(formData.nationalId)) {
      newErrors.nationalId = 'National ID must be exactly 9 digits';
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary-400 to-primary-600 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-white">Join JAMII LOAN</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="isCitizen" className="ml-2 block text-sm text-gray-900">
                I am a Kenyan citizen (Optional)
              </label>
            </div>
